...
I kept the forecast layout the same as the example from the spec, including significant digits for temperature readings, to reflect requirements. Arguably it would be more user centric to round to the nearest degree.
